...
func (F_medicaResp) TableName() string {
	return "fichamedicas" // Nombre de la tabla en la base de datos
}

type F_medicaListResponse struct {
	Items      []F_medicaResp `json:"items"`
	TotalCount int64          `json:"totalCount"`
}

// Create---Req  request struct
type CreateF_medicaReq struct {
...
func (CreateF_medicaReq) TableName() string {
	return "fichamedicas" // Nombre de la tabla en la base de datos
}

type UpdateF_medicaReq struct {
	ID        string     `json:"-"`
	SaleId    *int64     `json:"sale_id"`
	Rutalumn  *string    `json:"rutalumn"`
	Dato1     *string    `json:"dato1"`
...
func (UpdateF_medicaReq) TableName() string {
	return "fichamedicas" // Nombre de la tabla en la base de datos
}
